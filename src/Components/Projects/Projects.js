		...
		let loadData = () => {
			try {
				if (current !== 0) {
					...
					this.prev_pro_name.current.innerHTML = this.projects[current - 1].project_name;
					this.prev_pro_des.current.innerHTML = this.projects[current - 1].description;
				}

				this.now_img.current.src = this.projects[current].img;
				this.now_pro_name.current.innerHTML = this.projects[current].project_name;
				...
				if (current !== 5) {
					...
					this.next_pro_name.current.innerHTML = this.projects[current + 1].project_name;
					this.next_pro_des.current.innerHTML = this.projects[current + 1].description;
				}
			} catch (e) {
				console.error(e);
			}
					...
					<div className="mt-5 row startPro container">
						...
						>
							...
							<div className=" desmall describe">
								<p className="container" ref={this.prev_pro_des} id="prev_pro_des" />
							</div>
						</div>
						{/* <!-- now --> */}
						<div id="now_card" className="project-box now col-sm-6 col-md-6 col-lg-6">
							...
							<div className="describe">
								<p className="container" ref={this.now_pro_des} id="now_pro_des" />
							</div>
